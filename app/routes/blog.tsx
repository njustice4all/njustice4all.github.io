...
export default function Blog() {
  ...
  return (
    <div className="mx-auto my-0 w-full max-w-[42em]">
      <h1 className="mb-20 text-2xl font-bold leading-[1.3] md:text-4xl">Blog</h1>
          ...
          <div key={index} className="mb-16">
            <h2 className="mb-4 mt-6 font-sans text-xl font-bold leading-[1.3] md:text-3xl">
              <Link
                prefetch="intent"
                to={post.slug}
                className="text-primary shadow-none hover:shadow-none"
              >
                {post.title}
              </Link>
            </h2>
